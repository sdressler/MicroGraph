...
public:
    ...
    tVertexIterator target(tEdgeIterator it) { return vertices.find((it->first).second); }
    tVertexIterator source(tEdgeIterator it) { return vertices.find((it->first).first);  }
